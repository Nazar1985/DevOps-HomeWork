...
ALTER TABLE public.orders_part OWNER TO postgres;
...
ALTER TABLE ONLY public.orders_part ATTACH PARTITION public.orders_1 FOR VALUES FROM (MINVALUE) TO (499);
...
ALTER TABLE ONLY public.orders_part ATTACH PARTITION public.orders_2 FOR VALUES FROM (499) TO (MAXVALUE);
